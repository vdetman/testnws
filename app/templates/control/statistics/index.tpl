...
<div class="row">
	<div class="col-sm-12">
		<div class="portlet">
			<div class="portlet-heading">
				<h3 class="portlet-title text-dark">Wildberries</h3>
				<div class="clearfix"></div>
			</div>
			<div class="portlet-body">
				<div id="byModulesWb" style="height: 200px;"></div>
				<script type="text/javascript">
					$.byModulesWbData = {$byModulesWbData};
				</script>
			</div>
		</div>
	</div>
...
<div class="row">
	<div class="col-sm-12">
		<div class="portlet">
			<div class="portlet-heading">
				<h3 class="portlet-title text-dark">OZON</h3>
				<div class="clearfix"></div>
			</div>
			<div class="portlet-body">
				<div id="byModulesOzon" style="height: 200px;"></div>
				<script type="text/javascript">
					$.byModulesOzonData = {$byModulesOzonData};
				</script>
			</div>
		</div>
	</div>
