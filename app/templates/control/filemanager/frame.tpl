...
<html>
	<head>
		...
		{if isset($add_css) && is_array($add_css)}
			{foreach from=$add_css item=$file}
				<link href="{$file}" rel="stylesheet" />
			{/foreach}
		{/if}

		{if isset($add_js) && is_array($add_js)}
			{foreach from=$add_js item=$file}
			...
			<tr>
				<td valign="top" class="pnlDirs" id="dirActions">
					...
					<div id="pnlLoadingDirs">
						...
						<img src="{FILEMGR_PUBLIC_PART}images/loading.gif" title="Loading directory tree, please wait..." />
					</div>
	...
	<div class="pnlFiles">
	   <div class="scrollPane">
		 <div id="pnlLoading">
		  ...
		  <img src="{FILEMGR_PUBLIC_PART}images/loading.gif" title="Loading files, please wait...">
		  </div>
